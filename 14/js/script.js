...
class AnimatedNumbers {
  ...
  startAnimationForNumber(element, stopCount, duration, currentCount, fps) {
    ...
    const animation = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["animateProgress"])((progress) => {
      now = Date.now();
      elapsed = now - then;
...
/***/ "./source/js/modules/animation-sea-calf.js":
/*!*************************************************!*\
  !*** ./source/js/modules/animation-sea-calf.js ***!
  \*************************************************/
/*! exports provided: default */
...
/* harmony import */ var _utils_timeFunctions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/timeFunctions.js */ "./source/js/utils/timeFunctions.js");
...
class Animation {
  constructor(options) {
    ...
    if (!this.options.easing) {
      this.options.easing = _utils_timeFunctions_js__WEBPACK_IMPORTED_MODULE_0__["default"].easeLinear;
    }
...
/*!*****************************************!*\
  !*** ./source/js/modules/animations.js ***!
  \*****************************************/
/*! exports provided: addPrizeSvgPathAnimation, startPrizeSvgAnimation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addPrizeSvgPathAnimation", function() { return addPrizeSvgPathAnimation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "startPrizeSvgAnimation", function() { return startPrizeSvgAnimation; });
const prizeSvgPathAnimationDur = `0.5s`;
const gapSize = 5;

const addPrizeSvgPathAnimation = (el) => {
...
const startPrizeSvgAnimation = (el) => {
      ...
      case `prizes`:
        if (currentScreen && currentScreen.id === `story`) {
          ...
          setTimeout(() => {
            ...
            Object(_prizes_animation__WEBPACK_IMPORTED_MODULE_1__["startPrizesAnimation"])();
...
const gameTimer = (timerMinutes) => {
  ...
  document.body.addEventListener(`screenChanged`, ({detail}) => {
    if (detail.screenName === `game`) {
      ...
      animation = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["animateDuration"])((elapsed) => {
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./source/js/modules/utils.js");
/* harmony import */ var _animated_numbers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animated-numbers */ "./source/js/modules/animated-numbers.js");
...
const numbers = new _animated_numbers__WEBPACK_IMPORTED_MODULE_1__["default"]({
  elements: `.prizes .prizes__desc b`,
  duration: 800,
  delay: 300
});

const startPrizesAnimation = async () => {
  numbers.animate();
  primaryAward.src = `img/primary-award.svg?${new Date().getTime()}`;
  await Object(_utils__WEBPACK_IMPORTED_MODULE_0__["delay"])(4000);
  secondaryAward.src = `img/secondary-award.svg?${new Date().getTime()}`;
  await Object(_utils__WEBPACK_IMPORTED_MODULE_0__["delay"])(2500);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _animations__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animations */ "./source/js/modules/animations.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  if (results.length) {
    for (let i = 0; i < showResultEls.length; i++) {
      showResultEls[i].addEventListener(`click`, function () {
        ...
        Object(_animations__WEBPACK_IMPORTED_MODULE_0__["startPrizeSvgAnimation"])(targetEl[0]);
      });
    }
  ...
  Array.from(resultTitles).forEach((resultTitle) => {
    Array.from(resultTitle.children).forEach((path) => {
      Object(_animations__WEBPACK_IMPORTED_MODULE_0__["addPrizeSvgPathAnimation"])(path);
    });
  });
});
...
/* harmony import */ var _animation_sea_calf_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animation-sea-calf.js */ "./source/js/modules/animation-sea-calf.js");
...
/* harmony import */ var _utils_timeFunctions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/timeFunctions.js */ "./source/js/utils/timeFunctions.js");
...
class Scene2DSeaCalf extends _scene_2d_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  initAnimations() {
    this.animations.push(new _animation_sea_calf_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      func: () => {
        this.drawScene();
      },
      duration: `infinite`,
  ...
  initPlaneAnimations() {
    this.animations.push(new _animation_sea_calf_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 500,
      delay: 1200,
      easing: _utils_timeFunctions_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeInQuad
    }));
  }
  ...
  initSeaCalfAnimations() {
    this.animations.push(new _animation_sea_calf_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      duration: 2000,
      delay: 1000,
      easing: _utils_timeFunctions_js__WEBPACK_IMPORTED_MODULE_2__["default"].easeOutElastic
    }));
...
/***/ "./source/js/modules/text-animation-change.js":
/*!****************************************************!*\
  !*** ./source/js/modules/text-animation-change.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TextAnimationChange; });
...
class TextAnimationChange {
  ...
  runAnimation(item) {
    if (!this[item.name]) {
      this[item.name] = new _text_animation__WEBPACK_IMPORTED_MODULE_0__["default"](item.selector, item.duration, item.activeClass, item.transitionProperty, item.noWords);
    }
  ...
  handleChangeScreen(e) {
    ...
    TITLES.forEach((item) => {
      if (this[item.name] && (this.prevScreen === item.screenName || !this.prevScreen)) {
...
/*!************************************!*\
  !*** ./source/js/modules/utils.js ***!
  \************************************/
/*! exports provided: delay, animateDuration, animateProgress */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _modules_text_animation_change__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/text-animation-change */ "./source/js/modules/text-animation-change.js");
/* harmony import */ var _modules_game_timer__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/game-timer */ "./source/js/modules/game-timer.js");
...
Object(_modules_game_timer__WEBPACK_IMPORTED_MODULE_10__["default"])();

const fullPageScroll = new _modules_full_page_scroll__WEBPACK_IMPORTED_MODULE_8__["default"]();
fullPageScroll.init();

const textAnimationChange = new _modules_text_animation_change__WEBPACK_IMPORTED_MODULE_9__["default"]();
...
/***/ "./source/js/utils/timeFunctions.js":
/*!******************************************!*\
  !*** ./source/js/utils/timeFunctions.js ***!
  \******************************************/
/*! exports provided: default */
